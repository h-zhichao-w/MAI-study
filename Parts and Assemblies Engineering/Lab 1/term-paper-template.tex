...
\title{Report of LAB 1} % replace with title of your term paper
\author{Zhichao WANG} % replace with your candidate number, not your name
\newcommand{\Coursecode}{Parts and Assemblies Engineering (Mr. Dukhnovskiy Denis)} % replace with course code and name
